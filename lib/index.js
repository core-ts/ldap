...
var ldap = __importStar(require("ldapjs"));
var Authenticator = (function () {
  function Authenticator(status, dn, options, attributes, m) {
    this.status = status;
    this.dn = dn;
  ...
  Authenticator.prototype.authenticate = function (user) {
    ...
    return bind(client, dn, user.password, this.attributes, this.map).then(function (acc) {
